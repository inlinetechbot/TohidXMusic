...
from TohidXMusic import Carbon, app
from TohidXMusic.utils.decorators.language import language, languageCB
from TohidXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from TohidXMusic.utils.pastebin import HottyBin
...
from TohidXMusic.core.mongo import mongodb
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from TohidXMusic import YouTube
