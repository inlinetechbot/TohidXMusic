...
from TohidXMusic.utils import HottyBin, get_channeplayCB, seconds_to_min
from TohidXMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from TohidXMusic.utils.decorators.language import language, languageCB
from TohidXMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="https://files.catbox.moe/x5jgzy.jpg",
        caption=_["queue_1"],
    )
