...
from TohidXMusic import YouTube, app
from TohidXMusic.core.call import Hotty
from TohidXMusic.misc import SUDOERS, db
from TohidXMusic.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from TohidXMusic.utils.formatters import seconds_to_min
from TohidXMusic.utils.inline import (
    close_markup,
    stream_markup,
    stream_markup_timer,
)
from TohidXMusic.utils.stream.autoclear import auto_clean
from TohidXMusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
